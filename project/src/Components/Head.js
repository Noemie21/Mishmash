        ...
        <div class="h-1/2 w-screen relative">
            ...
            <div class="h-full w-screen gb-yellow absolute top-0 flex flex-col justify-center items-center">
                ...
                <div class="flex flex-row w-1/6 justify-between items-center">
                    <a href="https://github.com/Noemie21" rel="noreferrer" target="_blank"><FaGithub className="text-yellow text-5xl"/></a>
                    <a href="https://www.linkedin.com/in/noémie-k/" rel="noreferrer" target="_blank"><FaLinkedin className="text-yellow text-5xl"/></a>
                    <a href="mailto:n.kpatenon+portfolio@gmail.com" rel="noreferrer" target="_blank"><FaEnvelope className="text-yellow text-5xl"/></a>
                </div>
            </div>
        </div>
